...
parser.add_argument('-s', '--size', type=float, nargs=2, default=[100, 100], help='Boundary size of the scene')
parser.add_argument('-p', '--points', type=int, default=100, help='Number of view points')
